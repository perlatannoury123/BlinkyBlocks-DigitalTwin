#ifndef DigitalTwinBBBlockCode_H_
#define DigitalTwinBBBlockCode_H_
...
inline static const Color BBColors[] = {RED, ORANGE, YELLOW, GREEN, CYAN, BLUE, PURPLE, GREY, WHITE, RED, ORANGE, BROWN, DARKGREEN, CYAN, DARKBLUE, PURPLE, DARKGREY, BLACK};

class DigitalTwinBBBlockCode : public BlinkyBlocksBlockCode {
private:
    int distance;
...
public :
    ...
    void runCommandAsync(const string& cmd);
...
/** needed to associate code to module                                      **/
    static BlockCode *buildNewBlockCode(BuildingBlock *host) {
        return (new DigitalTwinBBBlockCode((BlinkyBlocksBlock*)host));
    };
/*****************************************************************************/
};

#endif /* DigitalTwinBBBlockCode_H_ */
